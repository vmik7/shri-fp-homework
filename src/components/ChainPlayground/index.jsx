        ...
        return (
            <div>
                <ol className={styles.description}>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <b>число</b> в 10-ной системе счисления
                    ...
                    <li>
                        Привести строку к числу, округлить к ближайшему целому с
                        точностью до единицы, <i>записать в writeLog</i>.
                    </li>
                    <li>
                        C помощью API /numbers/base перевести из 10-й системы
                        счисления в двоичную, результат{' '}
                    ...
                    <li>
                        C помощью API /animals.tech/id/name получить случайное
                        животное используя полученный остаток в качестве id
                    </li>
                    <li>
                        Завершить цепочку вызовом <i>handleSuccess</i> в который
                        в качестве аргумента положить результат полученный на
                        предыдущем шаге
                    </li>
                </ol>
